...
\title{\normalfont{ML Tek 5: feature selection}} 
...
All the code and the templates are in the \textbf{day\textunderscore 4/feature\textunderscore selection/} folder.
\\
...
Save the vocabulary \textbf{effectively used} by the obtained estimator, along with the
